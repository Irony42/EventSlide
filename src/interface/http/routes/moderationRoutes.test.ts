...
const usecasesFor = (deps: HttpDeps, { photos, reactions, media }: Adapters): HttpUseCases => {
  ...
  return {
    ...
    listMissions: notWired,
    createMission: notWired,
    updateMission: notWired,
    deleteMission: notWired,
    getGuestChecklist: notWired,
    createShareLink: notWired,
    getShareLink: notWired,
    revokeShareLink: notWired,
    openGallery: notWired,
    unlockGallery: notWired,
    listGalleryPhotos: notWired,
    getGalleryMedia: notWired,
    downloadGalleryArchive: notWired,
