...
export const createFfmpegVideoTranscoder = ({
  ...
  return {
    // This factory is only ever reached when the capability check found both binaries
    // and a usable libx264; the box with nothing on it gets `nullVideoTranscoder`.
    available: () => true,
